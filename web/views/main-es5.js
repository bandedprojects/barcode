...
module.exports = "\nmat-sidenav {\n    width: 250px;\n  }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var BarcodeComponent = /** @class */ (function () {
    ...
    BarcodeComponent.prototype.onSaveAndPrintClick = function () {
        ...
        var batchtype = this.printBarcodeForm.value.batchtype;
        var dialogConfig;
        var batch = this.batchesList.find(function (element) {
            if (element.batchtype == _this.printBarcodeForm.value.batchtype && element.batchname == _this.printBarcodeForm.value.batchname) {
                return element;
            }
        });
            ...
            if (found) {
                ...
                this.batchService.rejectedCylindersList(data).subscribe(function (responseData) {
                    ...
                    if (responseData.status == '1') {
                        ...
                        if (rejected_batch) {
                            dialogConfig = {
                                description: "The Cylinder " + _this.serial_no + "is already rejected in quality audit."
                            };
                    ...
                    _this.barcode_weight = _this.batchService.roundOFF(_this.printBarcodeForm.value.weight).toFixed(1).toString() + "kg";
    ...
    BarcodeComponent.prototype.refreshWeight = function () {
        var _this = this;
        this.batchService.getTareWeight().subscribe(function (responseData) {
            if (responseData.status == "1") {
                var tareweight = responseData.data.weight;
...
var BatchService = /** @class */ (function () {
    ...
    BatchService.prototype.prepareReportDataSource = function (start, end, report, rejectionsList) {
        ...
        var _loop_1 = function (i) {
            ...
            var status_key = "status" + k;
            var rejectedSerialNo = void 0;
            if (rejectionsList.length) {
                rejectedSerialNo = rejectionsList.find(function (element) { return element.serial_number == i; });
            }
            ...
            batchItem = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, batchItem, (_a = {}, _a[serial_no_index] = i.toString().padStart(6, '0'), _a[status_key] = status, _a));
            if (k == 6 || i == end) {
                k = 1;
                this_1.batchData.push(batchItem);
                batchItem = {};
            }
            else {
                ++k;
    ...
    BatchService.prototype.roundOFF = function (num) {
        var n = parseFloat(num) * 100;
    ...
    BatchService.prototype.prepareTareWeigthReportDataSource = function (start, end, tareweightCylinders) {
        this.batchData = [];
        var batchItem;
        batchItem = {};
        var status = "OK";
        ...
        var _loop_2 = function (i) {
            var _a;
            //batchItem = {};     
            var batch_tareweight = void 0;
            if (tareweightCylinders.length) {
                batch_tareweight = tareweightCylinders.find(function (element) { return element.serial_number == i; });
                var tare_weight_left_value = "0";
                var tare_weight_right_value = "0";
                var tareweight_value = "0";
                if (batch_tareweight != undefined) {
                    tareweight_value = batch_tareweight.weight;
                    var tareweight_array = String(tareweight_value).split('.');
                    ...
                    tareweight_value = this_2.roundOFF(tareweight_value).toString();
                }
                //const tareweight_value = batch_tareweight == undefined ? 0 : 0;
                var serial_no_index = "serial_no" + j;
                var tare_weight_left = "tare_weight_left" + j;
                var tare_weight_right = "tare_weight_right" + j;
                var tareweight = "tareweight" + j;
                batchItem = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, batchItem, (_a = {}, _a[serial_no_index] = i.toString().padStart(6, '0'), _a[tare_weight_left] = tare_weight_left_value, _a[tare_weight_right] = tare_weight_right_value, _a[tareweight] = tareweight_value, _a));
                if (j == 2 || i == end) {
                    j = 1;
                    this_2.batchData.push(batchItem);
                    batchItem = {};
                }
                else {
                    ++j;
    ...
    BatchService.prototype.getSubSlot = function (serial_no, start_serial) {
        var index = Math.ceil(((serial_no + 1) - start_serial) / 250);
    ...
    BatchService.prototype.prepareDispatchDataSource = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            batchItem = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, batchItem, (_a = {}, _a[serial_no_index] = data[i].serial_number.toString().padStart(6, '0'), _a[status_key] = status_1, _a));
    ...
    BatchService.prototype.getLastSerial = function (data) {
    ...
    BatchService.prototype.modifyRejection = function (data) {
    ...
    BatchService.prototype.getTareWeight = function () {
    ...
    BatchService.prototype.updateDispatch = function (slNos, batchname) {
        var data = {
            "batchname": batchname,
            "serialnumber": slNos
        };
        return this.http.post('/updateDispatch', data);
    };
    BatchService.prototype.getDispatchedLength = function (tareweight_cylinders) {
        return tareweight_cylinders.filter(function (obj) { return obj.dispatch_status == '1'; }).length;
    };
...
var CreateBatchComponent = /** @class */ (function () {
    ...
    CreateBatchComponent.prototype.batchTypeSelect = function () {
        var _this = this;
        var data = {
    ...
    CreateBatchComponent.prototype.onSubmit = function () {
        var _this = this;
        var start = this.createBatchForm.value.serial_start;
        var end = this.createBatchForm.value.serial_end;
        var dialogConfig = {};
        var error = false;
        ...
        if (error) {
            var dialogRef = this.dialog.open(_app_dialog_app_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AppDialogComponent"], {
                data: dialogConfig
            });
            return;
        }
...
var PrepareBatchComponent = /** @class */ (function () {
    ...
    PrepareBatchComponent.prototype.batchTypeSelect = function () {
        var _this = this;
        var data = {
    ...
    PrepareBatchComponent.prototype.onSubmit = function () {
        var start = this.prepareBatchForm.value.starting_serial_no;
...
var DispatchComponent = /** @class */ (function () {
    function DispatchComponent(batchService, dialog, sanitizer) {
        this.batchService = batchService;
        this.dialog = dialog;
    ...
    DispatchComponent.prototype.onDownload = function () {
        var _this = this;
        var dialogConfig;
        var batch = this.batchesList.find(function (element) {
            if (element.batchtype == _this.dispatchForm.value.batchtype && element.batchname == _this.dispatchForm.value.batchname) {
                return element;
            }
        });
        if (batch) {
            ...
            this.batchService.rejectedCylindersList(data_1).subscribe(function (responseData) {
                var rejection_list = [];
                if (responseData.status == '1') {
                    rejection_list = responseData.data.rejectionslist.map(function (element) { return element.serial_number; });
                }
                _this.batchService.tareweightCylindersList(data_1).subscribe(function (responseData) {
                    var tareWeightData = [];
                    if (responseData.status == "1") {
                        tareWeightData = responseData.data.tareweight.map(function (element) {
                            return {
    ...
    DispatchComponent.ctorParameters = function () { return [
...
var EditDispatchComponent = /** @class */ (function () {
    ...
    EditDispatchComponent.prototype.onFilterChange = function () {
        ...
        if (value == '2') {
            ...
            var filteredTareWeight = this.tareWeghtBkp.filter(function (element) { return element.dispatch_status == value; });
    ...
    EditDispatchComponent.prototype.updateDispatch = function () {
        ...
        this.batchService.tareweightCylindersList(this.TareWeightPostData).subscribe(function (responseData) {
            ...
            var dialogConfig = {};
            if (responseData.status == '1') {
                _this.tareWeghtBkp = tareweight_cylinders = responseData.data.tareweight;
                _this.displayBatchSection = true;
                _this.dataSource.data = _this.batchService.prepareDispatchDataSource(tareweight_cylinders);
                var dispatched_length = _this.batchService.getDispatchedLength(_this.tareWeghtBkp);
                _this.tareweight_completed = dispatched_length + '/' + _this.total_cylinders;
            }
            else if (responseData.status == '0') {
                dialogConfig = {
    ...
    EditDispatchComponent.prototype.onFilesAdded = function (fileList) {
        var file = fileList[0];
        ...
        fileReader.onload = function (x) {
            if (typeof fileReader.result == "string") {
                ...
                allTextLines.shift();
                var result = allTextLines.map(function (x) {
                    var entry = x.split(",");
                    if (entry.length) {
                ...
                self.uploading = true;
                self.batchService.updateDispatch(result, self.uploadBatchname).subscribe(function (responseData) {
                    var message = "";
                    ...
                    var dialogRef = self.dialog.open(src_app_app_dialog_app_dialog_component__WEBPACK_IMPORTED_MODULE_4__["AppDialogComponent"], {
                        data: {
                            description: message
                        }
                    });
    ...
    EditDispatchComponent.prototype.addFiles = function () {
        this.file.nativeElement.click();
        this.file.nativeElement.value = "";
    };
    EditDispatchComponent.prototype.uploadFileContent = function () {
    };
    ...
    ], EditDispatchComponent.prototype, "file", void 0);
...
var ModifyRejectionsComponent = /** @class */ (function () {
    ...
    ModifyRejectionsComponent.prototype.showCustomMessage = function (message) {
        var dialogRef = this.dialog.open(src_app_app_dialog_app_dialog_component__WEBPACK_IMPORTED_MODULE_5__["AppDialogComponent"], {
            data: {
                description: message
            }
    ...
    ModifyRejectionsComponent.prototype.onSearchClick = function () {
        ...
        if (this.batches.length) {
            ...
            var batchtype_1 = this.searchSerialNoForm.value.batchtype;
            var searchBatch_1 = this.batches.find(function (element) {
                if (element.batchtype == batchtype_1 && (parseInt(element.serial_start) <= serialno_1 && parseInt(element.serial_end) >= serialno_1)) {
                    return element;
                }
            });
            if (searchBatch_1 && searchBatch_1.batchname) {
                var data = {
                    "batchname": searchBatch_1.batchname,
                    "batchtype": searchBatch_1.batchtype
                };
                this.batchService.rejectedCylindersList(data).subscribe(function (responseData) {
                    if (responseData.status == '1') {
                        var rejectedCylinder = responseData.data.rejectionslist.find(function (element) {
                            if (element.serial_number == _this.searchSerialNoForm.value.serialno) {
                                return element;
                            }
                        });
                        if (rejectedCylinder != undefined) {
                            _this.modifyRejectionsForm.patchValue({
                                batchname: searchBatch_1.batchname,
                            ...
                            _this.showCustomMessage('Cylinder not found in rejected cylinders list');
    ...
    ModifyRejectionsComponent.prototype.onRejectSubmit = function () {
        var _this = this;
        var data = this.modifyRejectionsForm.value;
        data.batchtype = this.searchSerialNoForm.value.batchtype;
        this.batchService.modifyRejection(data).subscribe(function (responseData) {
            var message = "";
...
var HstreportsComponent = /** @class */ (function () {
    function HstreportsComponent(batchService, dialog) {
        this.batchService = batchService;
        this.dialog = dialog;
    ...
    HstreportsComponent.prototype.onGenerateClick = function () {
        ...
        this.batch = this.batchesList.find(function (element) {
            if (element.batchtype == _this.generateReportForm.value.batchtype && element.batchname == _this.generateReportForm.value.batch_name) {
                return element;
            }
        });
        if (this.batch) {
...
var PneumaticreportComponent = /** @class */ (function () {
    function PneumaticreportComponent(batchService, dialog) {
        this.batchService = batchService;
        this.dialog = dialog;
        this.showHSTReport = false;
        this.batchesList = [];
...
var TareweightComponent = /** @class */ (function () {
    function TareweightComponent(batchService, dialog) {
        this.batchService = batchService;
        this.dialog = dialog;
    ...
    TareweightComponent.prototype.onGenerateClick = function () {
        ...
        this.batchService.tareweightCylindersList(data).subscribe(function (responseData) {
            var tareweight_cylinders = [];
            var total_cylinders = (_this.batch.serial_end - _this.batch.serial_start) + 1;
            _this.tareweight_completed = '0/' + total_cylinders;
            if (responseData.status == '1') {
                tareweight_cylinders = responseData.data.tareweight;
                console.log(tareweight_cylinders.length);
                _this.tareweight_completed = tareweight_cylinders.length + '/' + total_cylinders;
            }
            _this.dataSource.data = _this.batchService.prepareTareWeigthReportDataSource(_this.batch.serial_start, _this.batch.serial_end, tareweight_cylinders);
