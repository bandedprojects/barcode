...
var BatchService = /** @class */ (function () {
    ...
    BatchService.prototype.prepareTareWeigthReportDataSource = function (start, end, tareweightCylinders) {
        ...
        for (var i = 0; i < col_length; i++) {
            ...
            var _loop_2 = function () {
                ...
                batchItem = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, batchItem, (_a = {}, _a[serial_no_index] = start_slno, _a[tare_weight_left] = tare_weight_left_value, _a[tare_weight_right] = tare_weight_right_value, _a[tareweight] = tareweight_value, _a));
            };
            for (var j = 1; j <= 2; j++) {
                _loop_2();
            }
    ...
    BatchService.prototype.getSubSlot = function (serial_no, start_serial) {
        var index = Math.ceil((serial_no - start_serial) / 250) - 1;
