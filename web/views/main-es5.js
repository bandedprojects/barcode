        ...
        if (batch) {
            if (found) {
                ...
                this.batchService.rejectedCylindersList(data).subscribe(function (responseData) {
                    ...
                    _this.barcode_weight = parseFloat(_this.printBarcodeForm.value.weight).toFixed(1);
